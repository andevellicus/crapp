...
export default function Profile() {
    ...
    const handleInputChange = (e) => { //
     ...
     const showSectionMessage = useCallback((section, text, type = 'error') => { //
        ...
        // Optional: Scroll to section on error/success
        setTimeout(() => { //
    ...
    const handleSubmit = async (e) => { //
        ...
        try {
            ...
            // Note: Saving notification prefs might happen within NotificationForm now
            // If NotificationForm handles its own saving via context, this call might not be needed here.
            // await saveNotificationPreferences(); // - This might move or be removed
    ...
    const handleDeleteAccount = async () => { //
        ...
        try {
            ...
            // Consider calling logout() from AuthContext here
            localStorage.clear(); // Or more specific clearing
            navigate('/login'); //
        } catch (error) { //
            ...
            // Show error INSIDE the modal if possible, or back in danger zone
             ...
             closeDeleteModal(); // Close modal even on error? Or keep open? Decide UX.
        } finally { //
            setIsSaving(false); //
                 ...
                 <form className="profile-form" onSubmit={handleSubmit}> 
                    ...
                    {activeSection === 'notifications' && (
                         <div ref={sectionRefs.notification} data-section="notification" className="form-section"> {/* Add ref and data-section */}
                            ...
                            <NotificationForm
                                // Pass necessary props if NotificationForm doesn't use context directly
                                // preferences={preferences}
                                // onPrefChange={handlePrefChange} ...etc
